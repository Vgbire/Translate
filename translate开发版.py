...
# 退出按钮，因为标题栏比隐藏了所以没啥用
# quit = tkinter.Button(window, text='退出', command=window.quit)
# quit.grid(row=1, column=1, sticky=tkinter.W, padx=5, pady=5)
# 打开日志
# file = tkinter.Button(window,text='日志',command=openFile)
